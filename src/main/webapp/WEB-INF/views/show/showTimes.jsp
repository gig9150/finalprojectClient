	...
	<div class="areas">
		<c:forEach var="i" items="${list }">
			<button type="button" class="btn btn-outline-default"
				value="${i }"
				style="height: 50px; width: 100px; font-size: unset;">${i }</button>
		</c:forEach>
		<div class="line"></div>
	</div>
	<div class="manycity">
...
<%-- 			<c:set target="${myDate}" property="time" value="${weeks }"/> --%>
<%-- 			<fmt:formatDate value="${myDate }" pattern="yyyy-MM-dd" var="regDates" /> --%>
